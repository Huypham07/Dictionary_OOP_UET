...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon("src/main/java/data/img/search.png");
        iconClose = new ImageIcon("src/main/java/data/img/close.png");
        iconLoading = new ImageIcon("src/main/java/data/img/loading.gif");
